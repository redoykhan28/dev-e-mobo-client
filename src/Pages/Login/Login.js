            ...
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <div className="text-center lg:w-5/12 lg:text-left">
                        <h1 className="text-5xl text-end font-bold">Login now!</h1>
                        <p className='text-md text-end mt-4 font-bold'>Need an Account? <Link to={'/signup'} className='text-secondary underline decoration-1'>SignUp</Link></p>
                    </div>
