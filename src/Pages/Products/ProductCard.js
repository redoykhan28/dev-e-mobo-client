...
const ProductCard = ({ product, setProductBook, reportProduct }) => {
    ...
    const { _id, product_name, phone, purchase_price, selling_price, location, purchase_date, published_date, product_img, condition, details, seller_name, seller_email, paid } = product
                                ...
                                <div className='flex items-center'>
                                    {
                                        ...
                                        <>
                                            ...
                                            <Link onClick={() => reportProduct(_id)} className='text-red-600'> Report to admin</Link>
                                        </>
                                    }
                                </div>
                            </div>
